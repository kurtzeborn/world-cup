...
Exact position picks (1st, 2nd, or 3rd) always earn 3 pts if correct — the team does not need to advance to earn those points.
...
- **3rd place exact credit is always awarded** when you correctly pick a team to finish 3rd, regardless of whether that team qualifies as one of the 8 advancing 3rd-place teams.
- 4th place is never scored (even if correct).
- Partial credit (1 pt) for a team only applies if that team actually advances (top 2, or as one of the qualifying 3rd-place teams).

### Group Stage Details

- Each group has 3 scoreable positions × 3 max points = **9 points max per group**
- 12 groups × 9 pts = **108 points max for group stage**
...
**Example — exact 3rd place, team doesn't advance:**
...
| 3rd: South Africa | 3rd: South Africa | **3** | Exact 3rd place — scores regardless of advancement |
| 4th: UEFA Path D | 4th: UEFA Path D | 0 | 4th place — never scored |
...
\* *Partial credit for a team at any position only applies if that team actually advances (top 2, or as one of the qualifying 3rd-place teams). Exact position (3 pts) is always awarded regardless.*
...
| Category | Max Points |
|----------|-----------|
| Group stage (12 groups × 9 pts) | 108 |
