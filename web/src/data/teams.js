...
// FIFA rankings updated April 2, 2026 — top 20 from April 1 release; ranks 21+ from Nov 2025 draw seeding
...
export const TEAMS = [
  ...
  { id: 'KOR', name: 'South Korea', group: 'A', groupSeed: 3, flagCode: 'kr', fifaRanking: 22, confirmed: true },
  { id: 'CZE', name: 'Czech Republic', group: 'A', groupSeed: 4, flagCode: 'cz', fifaRanking: 40, confirmed: true },

  // Group B
  { id: 'CAN', name: 'Canada', group: 'B', groupSeed: 1, flagCode: 'ca', fifaRanking: 27, confirmed: true },
  { id: 'BIH', name: 'Bosnia and Herzegovina', group: 'B', groupSeed: 2, flagCode: 'ba', fifaRanking: 55, confirmed: true },
  { id: 'QAT', name: 'Qatar', group: 'B', groupSeed: 3, flagCode: 'qa', fifaRanking: 52, confirmed: true },
  ...
  { id: 'SCO', name: 'Scotland', group: 'C', groupSeed: 4, flagCode: 'gb-sct', fifaRanking: 36, confirmed: true },

  // Group D
  { id: 'USA', name: 'United States', group: 'D', groupSeed: 1, flagCode: 'us', fifaRanking: 16, confirmed: true },
  { id: 'PAR', name: 'Paraguay', group: 'D', groupSeed: 2, flagCode: 'py', fifaRanking: 39, confirmed: true },
  { id: 'AUS', name: 'Australia', group: 'D', groupSeed: 3, flagCode: 'au', fifaRanking: 26, confirmed: true },
  ...
  { id: 'CIV', name: 'Ivory Coast', group: 'E', groupSeed: 3, flagCode: 'ci', fifaRanking: 42, confirmed: true },
  ...
  { id: 'TUN', name: 'Tunisia', group: 'F', groupSeed: 4, flagCode: 'tn', fifaRanking: 40, confirmed: true },

  // Group G
  { id: 'BEL', name: 'Belgium', group: 'G', groupSeed: 1, flagCode: 'be', fifaRanking: 9, confirmed: true },
  { id: 'EGY', name: 'Egypt', group: 'G', groupSeed: 2, flagCode: 'eg', fifaRanking: 34, confirmed: true },
  { id: 'IRN', name: 'Iran', group: 'G', groupSeed: 3, flagCode: 'ir', fifaRanking: 20, confirmed: true },
  ...
  { id: 'ALG', name: 'Algeria', group: 'J', groupSeed: 2, flagCode: 'dz', fifaRanking: 35, confirmed: true },
  ...
  { id: 'PAN', name: 'Panama', group: 'L', groupSeed: 4, flagCode: 'pa', fifaRanking: 30, confirmed: true },
];
