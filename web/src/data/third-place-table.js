...
/**
 * Get 3rd-place team match slot assignments for a given set of 8 qualifying groups.
 * @param {string[]} advancingGroups - Array of 8 group letters that qualified
 * @returns {string[]|null} Array of 8 group letters [M74, M77, M79, M80, M82, M81, M85, M87]
 */
export function getThirdPlacePlacements(advancingGroups) {
